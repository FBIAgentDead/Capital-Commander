Shader "MyShaders/Hologram Efect"
{
    Properties
    {
		...
		_Fragments("Fragments of the hologram", Range(2,100)) = 10
		_BlinkMagnitude("The blinking speed of the hologram", Range(2,100)) = 100
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				col *= _Color;
				col.a = _Trans;
				//clip(1 - (sin(i.vertex.y + _Time.w) * _BlinkMagnitude % _Fragments));
